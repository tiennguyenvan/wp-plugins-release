...
add_action('init', 'sneeit_core_load_textdomain');
// add_action('plugins_loaded', 'sneeit_core_load_textdomain');
// add_action('after_theme_setup', 'sneeit_core_load_textdomain');
function sneeit_core_load_textdomain() {	
    load_plugin_textdomain( 'sneeit-core', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
...
//         )
//     );
//     define('SNEEIT_CORE_VERSION', SNEEIT_CORE_IS_LOCAL ? time() : '23.12.06-0658');

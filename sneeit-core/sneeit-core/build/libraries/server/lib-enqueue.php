 ...
 *
 * @param object|array|string $sneeit_core_le_file check var-def#112.
 * @param object|array|string $sneeit_core_le_dep check var-def#112.
 */
...
/**
 * Check Documentation#1111
 *
 * @param object|array|string $sneeit_core_le_files check var-def#1111.
 */
...
/**
 * Check Documentation#1126
 *
 * @param object|array|string $sneeit_core_le_slug check var-def#1126.
 * @param object|array|string $sneeit_core_le_location check var-def#1126.
 * @param object|array|string $sneeit_core_le_dependencies check var-def#1126.
 */
	...
	add_action(
		...
		function() use ( $sneeit_core_le_slug, $sneeit_core_le_location, $sneeit_core_le_dependencies ) {
			...
			wp_localize_script( 'jquery', 'sneeitCore', array(
				...
				// dev-reply#1197.
				'sneeitLicenseUsername' => get_option( SNEEIT_CORE_KEY_SNEEIT_LICENSE_USERNAME, '' ), // dev-reply#1198.,
			) );

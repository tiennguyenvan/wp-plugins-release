...
function dragblock_editor_init_editor_assets() {
	...
	dragblock_enqueue( DRAGBLOCK_EDITOR_INIT_SLUG, 'build/applications/editor-init/client/index.js', array( 'jquery' ) );
	...
	// dev-reply#322.
	wp_localize_script( DRAGBLOCK_EDITOR_INIT_SLUG, 'dragBlockEditorInit', $dragblock_0 );
}
...
function dragblock_editor_init_editor_iframe() {
	...
	if ( ! DRAGBLOCK_CUSTOM_DEFAULT_STYLE ) {
		add_editor_style( DRAGBLOCK_URL . 'build/applications/editor-init/client/style-index.css' );
	}
}

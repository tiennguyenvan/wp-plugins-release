 ...
 *
 * @param object|array|string $dragblock_0 check var-def#47.
 */
function dragblock_default_theme_json( $dragblock_0 ) {
	global $dragblock_update_theme_json;
	if ( ! empty( $dragblock_update_theme_json ) ) {
		return $dragblock_0->update_with( $dragblock_update_theme_json );
	}
	$dragblock_update_theme_json = $dragblock_0->get_data();

 ...
 */
function dragblock_shortcode_post_author_bio( $dragblock_s_queries, $dragblock_s_current = null ) {
	if ( ! $dragblock_s_current ) {
		$dragblock_s_current = dragblock_get_current_list_query_id();
	}
	if ( ! $dragblock_s_current ) {
	...
	$dragblock_s_tags = get_post_field( 'post_author', $dragblock_s_current );
	// dev-reply#24331.
	$dragblock_s_srcset = get_the_author_meta( 'description', $dragblock_s_tags );
	// dev-reply#24334.
	return $dragblock_s_srcset;
}
add_shortcode( 'dragblock.post.cat.name', 'dragblock_shortcode_post_cat_name' );
/**
 * Check Documentation#24247
 *
 * @param object|array|string $dragblock_s_queries check var-def#24247.
 * @param object|array|string $dragblock_s_current check var-def#24247.
 */
function dragblock_shortcode_post_cat_name( $dragblock_s_queries, $dragblock_s_current = null ) {
	...
	if ( ! empty( $dragblock_s_date ) ) {
		foreach ( $dragblock_s_date as $dragblock_s_formatted ) {
			if ( 0 === $dragblock_s_formatted->category_parent ) {
				return $dragblock_s_formatted->name;
			}
			if ( empty( $dragblock_s_format ) ) {
				$dragblock_s_format = $dragblock_s_formatted->name;
			}
		}
	}
	return $dragblock_s_format; // dev-reply#24370.
}
add_shortcode( 'dragblock.post.cat.url', 'dragblock_shortcode_post_cat_url' );
/**
 * Check Documentation#24270
 *
 * @param object|array|string $dragblock_s_queries check var-def#24270.
 * @param object|array|string $dragblock_s_current check var-def#24270.
 */
function dragblock_shortcode_post_cat_url( $dragblock_s_queries, $dragblock_s_current ) {
	...
	if ( ! empty( $dragblock_s_date ) ) {
		foreach ( $dragblock_s_date as $dragblock_s_formatted ) {
			if ( 0 === $dragblock_s_formatted->category_parent ) {
				return esc_url_raw( get_category_link( $dragblock_s_formatted->term_id ) );
			}
			if ( empty( $dragblock_s_author ) ) {
				$dragblock_s_author = esc_url_raw( get_category_link( $dragblock_s_formatted->term_id ) );
			}
		}
	}
	return $dragblock_s_author ? $dragblock_s_author : '#empty_cat_id'; // dev-reply#24400.
}
 ...
 * @param object|array|string $dragblock_s_current check var-def#24293.
 */
function dragblock_shortcode_post_cat_id( $dragblock_s_queries, $dragblock_s_current = null ) {
	...
	if ( ! empty( $dragblock_s_date ) ) {
		foreach ( $dragblock_s_date as $dragblock_s_formatted ) {
			if ( 0 === $dragblock_s_formatted->category_parent ) {
				return $dragblock_s_formatted->term_id;
			}
		}
	}
	return - 1;
...
/**
 * Check Documentation#24331
 *
 * @param object|array|string $dragblock_s_queries check var-def#24331.
 */
...
/**
 * Check Documentation#24337
 *
 * @param object|array|string $dragblock_s_queries check var-def#24337.
 */
...
/**
 * Check Documentation#24355
 *
 * @param object|array|string $dragblock_s_queries check var-def#24355.
 */
...
/**
 * Check Documentation#24361
 *
 * @param object|array|string $dragblock_s_queries check var-def#24361.
 */
...
/**
 * Check Documentation#24373
 *
 * @param object|array|string $dragblock_s_queries check var-def#24373.
 */
 ...
 *
 * @param object|array|string $dragblock_s_queries check var-def#24379.
 */
...
/**
 * Check Documentation#24384
 *
 * @param object|array|string $dragblock_s_name check var-def#24384.
 */
function dragblock_kses_allowed_protocols( $dragblock_s_name ) {
	$dragblock_s_name[] = 'data';
	$dragblock_s_name[] = 'javascript';
	return $dragblock_s_name;
}

...
function dragblock_init_defines() {
	$dragblock_s_upload_dir = wp_upload_dir();
	define( 'DRAGBLOCK_UPLOAD_DIR', $dragblock_s_upload_dir['basedir'] . '/dragblock' );
	define( 'DRAGBLOCK_UPLOAD_URL', $dragblock_s_upload_dir['baseurl'] . '/dragblock' );
	// dev-reply#323.
}

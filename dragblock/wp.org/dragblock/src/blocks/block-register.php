...
function dragblock_block_init() {
	...
	$dragblock_br_path = DRAGBLOCK_BUILD_PATH . 'blocks/';
	// dev-reply#426.
	$dragblock_br_blocks = array(
		// dev-reply#428.
		'wrapper',
		'link',
		'icon',
	...
	foreach ( $dragblock_br_blocks as $dragblock_br_block ) {
		register_block_type( $dragblock_br_path . $dragblock_br_block );
	}
	// dev-reply#446.
 ...
 *
 * @param object|array|string $dragblock_br_categories check var-def#432.
 */
function dragblock_register_block_category( $dragblock_br_categories ) {
	array_unshift(
		$dragblock_br_categories,
		array(
			'slug'  => 'dragblock-form',
